...
namespace HIVBackend.Controllers.Search.LEGACY
{
    ...
    [ApiController]
    public class DEL_SearchAnalyseController : ControllerBase
    {
        private readonly HivContext _context;
        public DEL_SearchAnalyseController(HivContext context)
        {
            _context = context;
        }
        ...
        [Authorize(Roles = "User")]
        public IActionResult GetRes(SearchAnalyseInputForm form)
        {
            int pageSize = 100;
            ...
            foreach (var key in typeof(SearchAnalyseInputForm).GetProperties())
            {
